...
{
    public class DurationToMinutesContinousConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (values[0] != null)
            {
                ...
                if (timeSpan != null)
                {
                    ...
                    //if (timeSpan.Add(expiredTime) >= new TimeSpan(1, 0, 0))
                    //    return timeSpan.Add(expiredTime).TotalMinutes.ToString();

                    return (timeSpan.Add(expiredTime)).ToString("mm");
                }
            }
