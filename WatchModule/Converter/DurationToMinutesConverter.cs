...
{
    public class DurationToMinutesConverter : IMultiValueConverter
    {
            ...
            if (values[0] != null)
            {
                ...
                if (timeSpan != null)
                {
                    ...
                    else
                    {
                        ...
                        return totalEndDuration.Subtract(new TimeSpan(0, timeSpan.Minutes, timeSpan.Seconds)).ToString("mm");
                    }
                }
            }
